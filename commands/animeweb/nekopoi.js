...
module.exports = {
    ...
    start: async(rimuru, m, { text }) => {
        if (text.toLowerCase() === "random") {
            ...
            //rimuru.sendFile(m.from, fetch.result.img, "", m, { caption }) yg gambarnya kena internet positif
            ...
            //rimuru.sendFile(m.from, fetch.result[0].img, "", m, { caption }) yg gambarnya kena internet positif
            rimuru.sendText(m.from, caption, m)
        } else {
